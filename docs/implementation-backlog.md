...
6. **Voice AI testing, privacy verification, polish, and portfolio demo** — Verify failure/retry paths, accessibility, browser behavior, provider retention settings, cost limits, and a synthetic demonstration. The owner-independent lifecycle hardening slice is implemented and awaits verification; dashboard privacy, region, model, voice, disclosure, and spending decisions remain owner-controlled.
